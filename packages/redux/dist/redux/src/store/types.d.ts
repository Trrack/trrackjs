...
export type Middlewares<State> = ReadonlyArray<Middleware<Record<string, unknown>, State>>;
export type PossibleMiddleware<State = any, M extends Middlewares<State> = Middlewares<State>> = ((g: CurriedGetDefaultMiddleware<State>) => M) | M;
