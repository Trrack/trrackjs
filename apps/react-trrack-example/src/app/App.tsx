...
function App() {
  ...
  useEffect(() => {
    addAction(
      ...
      (task: Task) => `Adding task ${task.taskNumber}`
    );
    ...
    addAction(
      ...
      (task: Task) => `Remove task ${task.taskNumber}`
    );
    ...
    addAction(
      ...
      (task: Task) => `Mark ${task.taskNumber} as completed.`
    );
    ...
    addAction(
      ...
      (task: Task) => `Mark ${task.taskNumber} as incomplete.`
    );
  }, [addAction]);
